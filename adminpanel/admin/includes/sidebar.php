                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading">MANAGE MODULES</li>
                                <li>
                                    <a href="" data-toggle="modal" data-target="#modalForAddModules">
                                        <i class="metismenu-icon pe-7s-plus">
                                        </i>Add Modules
                                    </a>
                                </li>
                                <li>
                                    <a href="home.php?page=manage-modules">
                                        <i class="metismenu-icon pe-7s-notebook">
                                        </i>Manage Modules
                                    </a>
                                </li>

                                <li class="app-sidebar__heading">MANAGE TASK</li>
                                <li>
                                    <a href="" data-toggle="modal" data-target="#modalForAddTask">
                                        <i class="metismenu-icon fa fa-tasks">
                                        </i>Add Task
                                    </a>
                                </li>
                                <li>
                                    <a href="home.php?page=manage-task">
                                        <i class="metismenu-icon fas fa-clipboard-list">
                                        </i>Manage Task
                                    </a>
                                </li>
