...
<!-- Modal for Add Task -->
<div class="modal fade" id="modalForAddTask" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
   <form class="refreshFrm" id="addTaskFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <input type="text" name="taskTitle" class="form-control form-control-sm" required>
              ...
              <input type="date" class="form-control form-control-sm" autocomplete="off" name="Sdate" value="<?php echo isset($start_date) ? date("Y-m-d",strtotime($start_date)) : '' ?>">
        </div>
        <div class="form-group">
              <label for="" class="control-label">Start Date</label>
              <input type="date" class="form-control form-control-sm" autocomplete="off" name="Edate" value="<?php echo isset($end_date) ? date("Y-m-d",strtotime($end_date)) : '' ?>">
        </div>
        <div class="form-group">
        <label for="" class="control-label">Description</label>
          <textarea name="taskDesc" id="myTextarea"></textarea>
        </div>
        </div>
      </div>
      <div class="modal-footer">
