    ...
    <div class="app-header__menu">
        ...
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <?php
                    $selModule = $conn->query("SELECT * FROM module_tbl ORDER BY mdl_id  ");

                    if($selModule->rowCount() > 0)
                    {
                        while ($selModuleRow = $selModule->fetch(PDO::FETCH_ASSOC)) { ?>
                            <a href="home.php?page=result&id=<?php echo $selModuleRow['mdl_id']; ?>" >
                            
                                <?php echo $selModuleRow['title']; ?>
                            </a>
                        <?php }
                    }
                    else
                    { ?>
                        <a href="#" class="pl-3">No Available Module</a>
                    <?php }
                ...
                <li class="app-sidebar__heading">TO-DO</li>
                                <li>
                                    <a href="home.php?page=task">
                                        <i class="metismenu-icon pe-7s-Task">
                                        </i>All Task
                                    </a>
                                </li>
